/*
 * App URI: modifySW
 * Source Location: modifySW.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("modifySW", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var submission_2 = new cpr.protocols.Submission("modifySW");
			submission_2.method = "put";
			submission_2.action = "/productMangement/modifySW";
			...
			app.supportMedia("all and (min-width: 740px) and (max-width: 1023px)", "layout");
			...
			(function(container){
				...
				(function(container){
					...
					numberEditor_1.bind("value").toDataMap(app.lookup("product_sw"), "simultaneous");
				...
				formLayout_3.setColumns(["16fr", "34px", "34px"]);
