...
(function(){
	var app = new cpr.core.App("output/outputContentView", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataMap_7 = new cpr.data.DataMap("title_name");
			dataMap_7.parseData({
				"columns" : [
					{"name": "product_name"},
					{"name": "output_title"}
			...
			if(typeof onDownloadAttachmentListSubmitDone == "function") {
				submission_4.addEventListener("submit-done", onDownloadAttachmentListSubmitDone);
			}
			app.register(submission_4);
			
			var submission_5 = new cpr.protocols.Submission("deleteZipFile");
			submission_5.async = true;
			submission_5.action = "/productMangement/deleteZipFile";
